...
function getIncludeStudent() {
	...
	if(clickBuyNongmgTicket == 'Y' && (clickBuyStudentTicket == 'N')){
		returnvalue = "1F";
	}
	return returnvalue;
...
//		
//	}
//	if(classname=="research_u" && ($("#nmg_submitQuery").attr("class")=='research_u')){
//		nmg_renameButton("nmg_search_u");
//	}
//};
//
...
//
function nmg_renameButton(classname) {
	var queryButton = $("#nmg_submitQuery");
	queryButton.removeClass();
	queryButton.addClass(classname); 
	if(classname=="research_u" && ($("#submitQuery").attr("class")=='research_u')){
		renameButton("search_u");
...
//	}else if(queryButton.attr("class")=="stu_search_u2"){
//		stu_renameButton("stu_search_x2");
//	}
	
};
//
//function nmg_invalidQueryButton() {
//	var queryButton = $("#nmg_submitQuery");
//	//queryButton.unbind("click");
//	queryButton.attr("disabled",true);
//	if(queryButton.attr("class")=="research_u"){
//		 nmg_renameButton("research_x");
//	}else if(queryButton.attr("class")=="nmg_search_u"){
//		 nmg_renameButton("nmg_search_x");
//	}
//};
//
...
//	}else if(queryButton.attr("class")=="stu_search_x2"){
//		stu_renameButton("stu_search_u2");
//	}
//	
//};
//
//function nmg_validQueryButton() {
//	var queryButton = $("#nmg_submitQuery");
//	queryButton.attr("disabled",false);
//	if(queryButton.attr("class")=="research_x"){
//		 nmg_renameButton("research_u");
//	}else if(queryButton.attr("class")=="nmg_search_x"){
//		 nmg_renameButton("nmg_search_u");
//	}
//};
...
var sendQueryFunc = function() {
	...
	if(_id=='nmg_submitQuery'){
		clickBuyNongmgTicket='Y';
	}else{
		clickBuyNongmgTicket='N';
	}
...
function onStopHover(str) {
	...
	$.ajax({
		type: "GET",   
		dataType: "json",   
		url: 'traindetail.php?method=queryaTrainStopTimeByTrainNo',
		data:{
			train_no:train_no,
